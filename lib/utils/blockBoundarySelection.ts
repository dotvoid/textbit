 ...
 * - deleting, typing, pasting or breaking - would merge nodes that don't
 * belong together, so callers use this to constrain those edits.
 *
...
export function deleteSelectedTextWithinNodes(editor: Editor, at: Range): void {
  Editor.withoutNormalizing(editor, () => {
    // Reverse so earlier text nodes keep their paths as later ones shrink.
